...
<div id="page">
    <div id="header">
        ...
        <div id="download"><A HREF="http://www.jgwy.net/soft/tz.rar">探针下载</A></div>
    </div>
...
<div id="footer">
&copy; <?php echo date("Y",time());?> <A HREF="http://www.jgwy.Net" target="_blank">Jgwy.Net</A> PHP探针 <?php echo $version; ?> All Rights Reserved.<br />
<?php $run_time = sprintf('%0.4f', microtime_float() - $time_start);?>
Processed in <?=$run_time?> seconds. <?=memory_usage();?> memory usage.
<br><IFRAME id=bframe border=0 marginWidth=0 frameSpacing=0 marginHeight=0  src="http://jgwy.net/baner.htm" frameBorder=0 width=728 scrolling=no height=90></IFRAME>
</div>
</div>
</body>
</html>